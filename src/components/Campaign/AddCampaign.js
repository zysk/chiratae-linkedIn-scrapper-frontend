...
export default function AddCampaign() {
    ...
    let tempArr = ["Indian Institute of Technology Bombay,Indian Institute of Management Bangalore,Indian Institute of Technology Delhi,Indian Institute of Management Calcutta,Birla Institute of Technology and Science Pilani,Indian Institute of Technology Kanpur,Indian Institute of Technology (Banaras Hindu University) Varanasi,Indian Institute of Technology Palakkad,Indian Institute of Technology Indore,Indian Institute of Technology Mandi,Indian Institute of Technology Gandhinagar,Indian Institute of Technology Ropar,Indian Institute of Technology (Indian School of Mines) Dhanbad,Indian Institute of Technology Kharagpur,Indian Institute of Technology Madras,Indian Institute of Technology Roorkee,Indian Institute of Technology Guwahati,Indian Institute of Management Ahmedabad,Indian Institute of Technology (IIT) Goa,Indian Institute of Technology Jodhpur,Indian Institute of Technology Hyderabad,Indian Institute of Technology, Patna"];
    ...
    const [school, setSchool] = useState("Indian Institute of Technology Delhi,Indian Institute of Technology Patna,Indian Institute of Technology Kharagpur,Indian Institute of Technology Kanpur,Indian Institute of Technology Roorkee,Indian Institute of Technology Madras,Indian Institute of Technology Bombay,Indian Institute of Management Ahmedabad,Indian Institute of Management Bangalore,Indian Institute of Management Calcutta,Birla Institute of Technology and Science,Shri Ram College of Commerce,Lady Shri Ram College");
    const [imageNumber, setImageNUmber] = useState(0)
    const [company, setCompany] = useState("Stealth, Stealth startup, stealth company");
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-lg-12" >
                            <DashboardBox className="dashboard-summary dashboard-box">
                                {
                                    ...
                                    <div className="row justify-content-end">
                                        <button onClick={() => handleLogout()} type={"button"} className={"align-self-end"} style={{ outline: "none", border: "none", width: 300, marginRight: 10, padding: "7px 70px", borderRadius: 10 }}>Logout</button>
                                    </div>
                                }

                                <div className="row d-flex justify-content-between mt-3 ">
                                    <h3 className="col-6 blue-1 font6updateadmin mb-4">Campaign for linkedIn</h3>
                                    <div className="col-3">
                                        <Select onChange={(e) => setUseTextInputs(e.value)} className='dropdownmenui' defaultValue={{ label: `Use default inputs`, value: false }} options={[{ label: `Use default inputs`, value: false }, { label: `Add new inputs`, value: true }]} />
                                    </div>
                                ...
                                <TextField sx={{ borderRadius: 5 }} id="outlined-basic" label="Campaign Name" variant="outlined" onChange={(e) => setName(e.target.value)} value={name} placeholder='Enter Campaign Name' className='form-control muiinput' />
                                <div className='col-lg-12 py-4'>
                                    <div className='borderbotm'></div>
                                </div>
                                {/* 
                            ...
                            */}
                                ...
                                {/* <hr /> */}
                                <h4 className="blue-1 font6updateadmin mb-4">Search query customization</h4>
                                ...
                                <div className='row'>
                                    <div className='col-lg-6 col-sm-6 col-md-6'>
                                        <TextField id="outlined-basic" label="Search query" variant="outlined" className='form-control muiinput' placeholder='Search Query' value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
                                    </div>
                                    <div className='col-lg-6 col-sm-6 col-md-6'>
...

                                        {
                                            useTextInputs ?
                                                ...
                                                :
                                                <Select value={company != "" ? companyArr.find(el => el.value == company) : {}} onChange={(e) => setCompany(e.value)} options={companyArr} />
                                        }
                                    </div>
                                </div>
                                    ...
                                    <div className='col-lg-6'>
                                        {
                                            useTextInputs ?
                                                ...
                                                :
                                                <Select value={pastCompany != "" ? companyArr.find(el => el.value == company) : {}} onChange={(e) => setPastCompany(e.value)} options={companyArr} />
                                        }
                                    </div>
                                    <div className='col-lg-6'>
                                        {
                                            useTextInputs ?
                                                ...
                                                :
                                                <Select value={school != "" ? schoolArr.find(el => el.value == school) : {}} onChange={(e) => setSchool(e.value)} options={schoolArr} />
                                        }
                                    </div>
                                </div>
...

                                {
                                    ...
                                    <>
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-6">
                                                <button disabled={loading} onClick={() => handleLogin()} type={"button"} style={{ outline: "none", border: "none", width: 300, marginRight: 10, padding: "7px 70px", borderRadius: 10, backgroundColor: "#D68392", color: 'white' }}>{loading ? 'Loading...' : "Login"}</button>
                                            </div>
                                        </div>
                                        <hr />
                                ...
                                }
                                {
                                    showLogin == false &&
                                    <>
                                        <button disabled={loading} onClick={() => handleBasicSearch()} type={"button"} style={{ outline: "none", border: "none", width: 300, marginRight: 10, padding: "10px 70px", borderRadius: 10, backgroundColor: "#D68392", marginTop: "15px", color: 'white' }}>{loading ? 'Loading...' : 'Start Searching'}</button>
...

                                {
                                    ...
                                    <div className="row d-flex">
                                        <button disabled={loading} onClick={() => handleBasicSearch()} type={"button"} style={{ outline: "none", border: "none", width: 300, marginRight: 10, padding: "10px 70px", borderRadius: 10, backgroundColor: "#D68392", marginTop: "15px", color: 'white' }}>{loading ? 'Loading...' : 'Run Now'}</button>
                                        {/* <button disabled={loading} onClick={() => setSchedule(true)} type={"button"} style={{ outline: "none", width: 300, marginRight: 10, padding: "10px 70px", borderRadius: 10, border: "#D68392 solid 1px", marginTop: "15px", backgroundColor: 'white' }}>Set Schedule Date</button> */}
                                    </div>
                                }
                                ...
                                {
                                    schedule &&
                                    <div className="mt-4" style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
                                        <input type="date" value={scheduleDate} onChange={() => setScheduleDate(scheduleDate)} className="form-control" style={{ width: 'unset' }} min={scheduleMinDate} />
                                        <button onClick={() => handleScheduledSearch()} type={"button"} style={{ outline: "none", border: "none", width: 300, marginLeft: 10, marginRight: 10, padding: "5px 70px", borderRadius: 10, backgroundColor: "#D68392", color: 'white' }}>Schedule for later</button>
                                    </div>
                                }
                            </DashboardBox>
